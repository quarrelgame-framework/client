...
import { Mouse, MouseButton, MouseMovement, OnMouseButton, OnMouseMove } from "controllers/mouse.controller";
import { InputMode, ConvertPercentageToNumber } from "@quarrelgame-framework/common";
